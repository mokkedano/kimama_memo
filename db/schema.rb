...
ActiveRecord::Schema.define(version: 2023_06_03_082259) do
  ...
  create_table "chat_messages", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["end_user_id"], name: "index_chat_messages_on_end_user_id"
  ...
  create_table "post_category_relations", force: :cascade do |t|
    ...
    t.index ["end_user_id"], name: "index_post_category_relations_on_end_user_id"
  ...
  add_foreign_key "chat_messages", "end_users"
  ...
  add_foreign_key "post_category_relations", "end_users"
